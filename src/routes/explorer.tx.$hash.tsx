...
import { formatEth, formatUnits, formatGwei, timeAgo, withCommas } from "@/lib/explorer/format";
    ...
    <div className="space-y-4">
      ...
      {tab === "overview" && (
        <Card>
          ...
          <Row label="Value">{formatEth(tx.value)} ETH</Row>
          <Row label="Transaction Fee">{formatUnits(tx.fee?.value, 18, 12)} ETH</Row>
