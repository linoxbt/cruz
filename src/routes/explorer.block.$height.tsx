...
import { formatEth, formatGwei, timeAgo, withCommas } from "@/lib/explorer/format";
    ...
    <div className="space-y-4">
      ...
      {tab === "overview" && (
        <Card>
          ...
          {block.rewards?.[0] && (
            <Row label="Block Reward">{formatEth(block.rewards[0].reward)} ETH</Row>
          )}
          <Row label="Gas Used">
          ...
          {block.burnt_fees && <Row label="Burnt Fees">{formatEth(block.burnt_fees)} ETH</Row>}
