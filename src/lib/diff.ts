// Minimal line-level diff (LCS) for the AI Builder's diff-review-before-apply
// view. No dependency — generated files are small, so the O(n*m) table is
// fine; very large inputs fall back to a whole-file replace rather than
// build a huge table.
